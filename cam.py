...
<html lang="ru">
    ...
    <body>
        <div class="bd-example" align="middle">
            <center><h1>Дипломная работа</h1></center>
        <center><img src="stream.mjpg" width="{width}" height="{height}"></center>
        <center><h2>Выполнили: Соколов Никита и Березин Марк</h2></center>
    </body>
</html>
"""
...
if __name__ == "__main__":
    width = 1920
    height = 1080
    with picamera.PiCamera(resolution=f'{width}x{height}', framerate=30) as camera:
